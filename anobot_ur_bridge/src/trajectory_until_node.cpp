/* Modified from https://github.com/UniversalRobots/Universal_Robots_ROS2_Driver/blob/jazzy/ur_robot_driver/src/trajectory_until_node.cpp
*/

#include <anobot_ur_bridge/trajectory_until_node.hpp>
#include <functional>
